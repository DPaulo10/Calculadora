...
while True:
    ...
    if operacao == 'Compra' or 'Venda':
        if operacao == 'Compra':
            while True:
                tipo_operacao = input('Qual o tipo de operação (Day trade/Normal)?').title()
                if tipo_operacao == 'Normal' or 'Day Trade':
                        ...
                        if resultado * 0.2 > 10:
                            credito_tributario = float(input('Se você possui créditos tributários provenientes de '
                                                            ...
                                                            '(Caso não possua créditos tributários, digite o valor '
                                                             '0.00).'))
                            print(f'O imposto de renda a recolher é de {(resultado - credito_tributario) * 0.2}')
                            break
                        elif resultado < 0:
                            print(f'Isento. Essa operação gerou um crédito tributário de {abs(resultado)}.')
                            break
                        else:
                            print(f'O valor de {round(resultado * 0.2, 2)} é inferior a R$ 10,00, portanto, o DARF '
                ...
                if tipo_operacao == 'Normal':
                    ...
                    if total_venda > 20000 and resultado * 0.15 > 10.0:
                        ...
                        print(f'O imposto de renda a recolher é de {(resultado - credito_tributario) * 0.15}')
                        break
                    elif resultado < 0:
                        print(f'Isento. Essa operação gerou um crédito tributário de {abs(resultado)}.')
                        break
                        ...
                        print(f'O valor de {round(resultado * 0.15, 2)} é inferior a R$ 10,00, portanto, o DARF não '
